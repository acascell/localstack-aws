...
#         f"/tmp/{input_image}", f"/tmp/{output_image}", secret_text
#     )
#
...
#
#
# def _retrieve_secret_text_from_concealed_image(
#     concealed_s3_image_path, secret_password_key
# ):
...
#
#     output_image_path = _add_secret_text_to_image(
#         input_image_path, secret_text, secret_password_key
#     )
...
#
#     secret_text = _retrieve_secret_text_from_concealed_image(
#         concealed_image_path, secret_password_key
#     )
